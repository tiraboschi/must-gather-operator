...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MustGatherImageWithParameters) DeepCopyInto(out *MustGatherImageWithParameters) {
	*out = *in
	if in.Command != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MustGatherImageWithParameters.
func (in *MustGatherImageWithParameters) DeepCopy() *MustGatherImageWithParameters {
	if in == nil {
		return nil
	}
	out := new(MustGatherImageWithParameters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *MustGatherSpec) DeepCopyInto(out *MustGatherSpec) {
	*out = *in
	...
	if in.MustGatherImagesWithParameters != nil {
		in, out := &in.MustGatherImagesWithParameters, &out.MustGatherImagesWithParameters
		*out = make([]MustGatherImageWithParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
